...
const enableSidebarSelectOnBlocks = ['core/audio'];
const {
...
wp.hooks.addFilter('editor.BlockEdit', 'custom-attributes/with-sidebar-select', addOptionInSidebar);
/**
...
const saveOptionFromSidebar = (extraProps, blockType, attributes) => {
  ...
  if (enableSidebarSelectOnBlocks.includes(blockType.name)) {
    ...
    if (playOnce) {
      extraProps.className = classnames__WEBPACK_IMPORTED_MODULE_2___default()(extraProps.className, 'audio-play-once-' + playOnce);
    }
  }
...
wp.hooks.addFilter('blocks.getSaveContent.extraProps', 'custom-attributes/save-sidebar-select-attribute', saveOptionFromSidebar);
...
/*!**********************!*\
  ...
  \**********************/
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var _audioOption__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./audioOption */ "./src/audioOption.js");
