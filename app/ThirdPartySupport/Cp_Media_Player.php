<?php
/**
 * File to handle support for plugin "CP Media Player".
 *
 ...
 */
class Cp_Media_Player extends ThirdPartySupport_Base {
	/**
	...
	public function init(): void {
		add_action( 'elementor/element/avp-audio/avp_section/before_section_end', array( $this, 'add_settings' ) );
	...
	public function render_setting( string $content, Widget_Base $instance ): string {
		...
		if ( 'avp-audio' !== $instance->get_name() ) {
			return $content;
		}
		...
		return str_replace( 'ms_avp"', 'ms_avp" class="audio-play-once-true"', $content );
	}
}
